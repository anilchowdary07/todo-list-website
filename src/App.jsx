...
function App() {
  ...
  return (
    <>
      <Navbar />
      <div className="mx-3 md:container md:mx-auto my-4 rounded-2xl p-5 bg-orange-200 min-h-[80vh] md:w-[35%]">
        <div className="addTodo my-5 flex flex-col gap-3">
          ...
          <div className="flex">
            <input onChange={handleChange} value={todo} type="text" className='bg-yellow-300 w-full rounded-full px-5 py-1' />
            <button onClick={handleAdd} disabled={todo.length <= 3} className='bg-blue-400 hover:bg-blue-200 p-2 py-1 mx-2 rounded-full
